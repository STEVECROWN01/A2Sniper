...
import { Bell, Link2, Clock, TrendingUp, TrendingDown, MessageCircle, X, RefreshCw, Download, Settings, BarChart3, Target, DollarSign, Zap } from 'lucide-react';
      ...
      <div className="relative flex flex-col items-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
             <span className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F3E5AB]">{Math.round(gaugeValue)}%</span>
          </div>
        </div>
                  ...
                  <div className="flex-1 space-y-6 w-full">
                    <div className="bg-[#050507] p-4 rounded-2xl border border-white/5">
                      ...
                      <p className="text-md font-black text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#F3E5AB]">
                        {avgWinrate > 95 ? 'A2SNIPER ENGINE ACTIVE' : 'HAUTE PRÉCISION NEURONALE'}
                      </p>
                    </div>
                    <div className="bg-[#050507] p-4 rounded-2xl border border-white/5">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#0a0a0c]/80 border border-white/5 p-8 rounded-3xl backdrop-blur-md">
              ...
              <div className="space-y-4 text-xs font-bold">
                <div className="p-3 border-l-2 border-[#D4AF37] bg-[#D4AF37]/5 text-gray-400 rounded-r-xl">
                  <p className="text-white font-black mb-1">Moteur Assistant synchronisé</p>
                  Poids LSTM / XGBoost synchronisés avec succès.
                </div>
                <div className="p-3 border-l-2 border-green-500 bg-green-500/5 text-gray-400 rounded-r-xl">
                  <p className="text-white font-black mb-1">Session Flux Validée</p>
