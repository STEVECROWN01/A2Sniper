    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          ...
          {/* AI Voting — Disabled (neural_models package removed) */}
          <div className="bg-gray-900/40 border border-gray-800 rounded-2xl p-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <Brain className="w-5 h-5 text-gray-600" />
                <h2 className="text-lg font-bold uppercase tracking-tighter">AI Voting</h2>
              </div>
              <div className="text-[10px] bg-gray-700/40 text-gray-400 px-2 py-0.5 rounded border border-gray-700">DISABLED</div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-gray-400 mb-2">AI voting classifier is disabled</p>
              <p className="text-xs text-gray-600 max-w-xs">
                The neural_models package (LSTM / Transformer / XGBoost) was removed from the codebase.
                Signals are generated by the ACE + Sniper engines only.
              </p>
            </div>
          </div>
        </div>
